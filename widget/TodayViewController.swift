...
class TodayViewController: NSViewController, NCWidgetProviding, NCWidgetListViewDelegate, NCWidgetSearchViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.listViewController.contents = ["Hello World!", "Another Hello World"]
    }
    ...
    @IBAction func onClickProfile(_ sender: Any) {
        openURL(string: "https://github.com/changjoo-park")
    }
    @IBAction func onClickOpenPullRequests(_ sender: Any) {
        openURL(string: "https://github.com/pulls")
    }
    
    @IBAction func onClickIssues(_ sender: Any) {
        openURL(string: "https://github.com/issues")
    }
    
    @IBAction func onClickRepositories(_ sender: Any) {
        openURL(string: "https://github.com/ChangJoo-Park?tab=repositories")
    }
    
    func openURL(string: String) {
        if let checkURL = NSURL(string: string) {
